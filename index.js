...
client.on('message', message =>{
    ...
    .setTitle("EclipseBOT")
    .setColor("RANDOM")
    .setDescription("Olá, sou o EclipseBOT, fui desenvolvido pelo <@490323052928696340>, meu prefixo é `!`, para saber mais informações, use !info, para ver meus comandos, use !comandos")

    .setTimestamp()
    .setFooter("EclipseBOT • @ImSkorped", client.user.avatarURL)
		...
		if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
			...
			try {
				...
				try {
                    ...
                    .setFooter("EclipseBOT • Sistema de musicas", client.user.displayAvatarURL)
